...
public class GetHashCode
{
    ...
    public void FirstNotEqualToFirst(NonNull<string> a) =>
        Assert.NotEqual(
            First<string, string, string, string, string>($"a{a.Get}").GetHashCode(),
            First<string, string, string, string, string>($"b{a.Get}").GetHashCode()
        );

    [Property(DisplayName = "First is not equal to Second")]
    public void FirstNotEqualToSecond(NonNull<string> a, NonNull<string> b) =>
        Assert.NotEqual(
            First<string, string, string, string, string>(a.Get).GetHashCode(),
            Second<string, string, string, string, string>(b.Get).GetHashCode()
        );
    ...
    public void FirstNotEqualToThird(NonNull<string> a, NonNull<string> b) =>
        Assert.NotEqual(
            First<string, string, string, string, string>(a.Get).GetHashCode(),
            Third<string, string, string, string, string>(b.Get).GetHashCode()
        );
    ...
    public void FirstNotEqualToFourth(NonNull<string> a, NonNull<string> b) =>
        Assert.NotEqual(
            First<string, string, string, string, string>(a.Get).GetHashCode(),
            Fourth<string, string, string, string, string>(b.Get).GetHashCode()
        );
    ...
    public void FirstNotEqualToFifth(NonNull<string> a, NonNull<string> b) =>
        Assert.NotEqual(
            First<string, string, string, string, string>(a.Get).GetHashCode(),
            Fifth<string, string, string, string, string>(b.Get).GetHashCode()
        );

    [Property(DisplayName = "Second is not equal to Second")]
    public void SecondNotEqualToSecond(NonNull<string> a) =>
        Assert.NotEqual(
            Second<string, string, string, string, string>($"a{a.Get}").GetHashCode(),
            Second<string, string, string, string, string>($"b{a.Get}").GetHashCode()
        );

    [Property(DisplayName = "Second is not equal to Third")]
    public void SecondNotEqualToThird(NonNull<string> a, NonNull<string> b) =>
        Assert.NotEqual(
            Second<string, string, string, string, string>(a.Get).GetHashCode(),
            Third<string, string, string, string, string>(b.Get).GetHashCode()
        );
    ...
    public void ThirdNotEqualToThird(NonNull<string> a) =>
        Assert.NotEqual(
            Third<string, string, string, string, string>($"a{a.Get}").GetHashCode(),
            Third<string, string, string, string, string>($"b{a.Get}").GetHashCode()
        );

    [Property(DisplayName = "Third is not equal to Fourth")]
    public void ThirdNotEqualToFourth(NonNull<string> a, NonNull<string> b) =>
        Assert.NotEqual(
            Third<string, string, string, string, string>(a.Get).GetHashCode(),
            Fourth<string, string, string, string, string>(b.Get).GetHashCode()
        );
    ...
    public void FourthNotEqualToFourth(NonNull<string> a) =>
        Assert.NotEqual(
            Fourth<string, string, string, string, string>($"a{a.Get}").GetHashCode(),
            Fourth<string, string, string, string, string>($"b{a.Get}").GetHashCode()
        );

    [Property(DisplayName = "Fourth is not equal to Fifth")]
    public void FourthNotEqualToFifth(NonNull<string> a, NonNull<string> b) =>
        Assert.NotEqual(
            Fourth<string, string, string, string, string>(a.Get).GetHashCode(),
            Fifth<string, string, string, string, string>(b.Get).GetHashCode()
        );
    ...
    public void FifthNotEqualToFifth(NonNull<string> a) =>
        Assert.NotEqual(
            Fifth<string, string, string, string, string>($"a{a.Get}").GetHashCode(),
            Fifth<string, string, string, string, string>($"b{a.Get}").GetHashCode()
        );
    ...
    public void FifthEqualToFifth(NonNull<string> a) =>
        Assert.Equal(
            Fifth<string, string, string, string, string>(a.Get).GetHashCode(),
            Fifth<string, string, string, string, string>(a.Get).GetHashCode()
        );
}

...
namespace DeFuncto.Tests.Core.Types.Du5
{
    public class Match
    {
        ...
        public void OnFirst() =>
            First<string, int, int, int, int>("ban").Match(
                val => $"{val}ana",
                val => $"{val}ana",
                val => $"{val}ana",
                val => $"{val}ana",
        ...
        public void OnSecond() =>
            Second<int, string, int, int, int>("ban").Match(
                val => $"{val}ana",
                val => $"{val}ana",
                val => $"{val}ana",
                val => $"{val}ana",
        ...
        public void OnThird() =>
            Third<int, int, string, int, int>("ban").Match(
                val => $"{val}ana",
                val => $"{val}ana",
                val => $"{val}ana",
                val => $"{val}ana",
        ...
        public void OnFourth() =>
            Fourth<int, int, int, string, int>("ban").Match(
                val => $"{val}ana",
                val => $"{val}ana",
                val => $"{val}ana",
                val => $"{val}ana",
        ...
        public void OnFifth() =>
            Fifth<int, int, int, int, string>("ban").Match(
                val => $"{val}ana",
                val => $"{val}ana",
                val => $"{val}ana",
                val => $"{val}ana",

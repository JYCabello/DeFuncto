...
public class Match
{
    ...
    public void OnFirst(NonNull<string> a, NonNull<string> b, NonNull<string> c) =>
        First<string, int, int, int, int>(a.Get).Match(
            val => $"{val}{b.Get}",
            val => $"{val}{c.Get}",
            val => $"{val}{c.Get}",
            val => $"{val}{c.Get}",
    ...
    public void OnSecond(NonNull<string> a, NonNull<string> b, NonNull<string> c) =>
        Second<int, string, int, int, int>(a.Get).Match(
            val => $"{val}{c.Get}",
            val => $"{val}{b.Get}",
            val => $"{val}{c.Get}",
            val => $"{val}{c.Get}",
    ...
    public void OnThird(NonNull<string> a, NonNull<string> b, NonNull<string> c) =>
        Third<int, int, string, int, int>(a.Get).Match(
            val => $"{val}{c.Get}",
            val => $"{val}{c.Get}",
            val => $"{val}{b.Get}",
            val => $"{val}{c.Get}",
    ...
    public void OnFourth(NonNull<string> a, NonNull<string> b, NonNull<string> c) =>
        Fourth<int, int, int, string, int>(a.Get).Match(
            val => $"{val}{c.Get}",
            val => $"{val}{c.Get}",
            val => $"{val}{c.Get}",
            val => $"{val}{b.Get}",
    ...
    public void OnFifth(NonNull<string> a, NonNull<string> b, NonNull<string> c) =>
        Fifth<int, int, int, int, string>(a.Get).Match(
            val => $"{val}{c.Get}",
            val => $"{val}{c.Get}",
            val => $"{val}{c.Get}",
            val => $"{val}{c.Get}",
